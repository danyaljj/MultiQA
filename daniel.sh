...
# SQuAD2-0 (06/18)
python multiqa.py train --datasets SQuAD2-0  --cuda_device 0,1
python multiqa.py train --datasets SQuAD1-1,NewsQA,SearchQA,TriviaQA_wiki,WikiHop,ComplexWebQuestions,DuoRC_Paraphrase,SQuAD2-0  --cuda_device 0,1


# ComQA (09/18)
python multiqa.py train --datasets ComQA  --cuda_device 0,1
python multiqa.py train --datasets SQuAD1-1,NewsQA,SearchQA,TriviaQA_wiki,WikiHop,ComplexWebQuestions,DuoRC_Paraphrase,SQuAD2-0,ComQA  --cuda_device 0,1


# DROP (03/19)
python multiqa.py train --datasets DROP  --cuda_device 0,1
python multiqa.py train --datasets SQuAD1-1,NewsQA,SearchQA,TriviaQA_wiki,WikiHop,ComplexWebQuestions,DuoRC_Paraphrase,SQuAD2-0,ComQA,DROP  --cuda_device 0,1


# HotpotQA (09/18)
python multiqa.py train --datasets HotpotQA  --cuda_device 0,1
python multiqa.py train --datasets SQuAD1-1,NewsQA,SearchQA,TriviaQA_wiki,WikiHop,ComplexWebQuestions,DuoRC_Paraphrase,SQuAD2-0,ComQA,DROP,HotpotQA  --cuda_device 0,1


# Natural Questions (?/19)
python multiqa.py train --datasets NaturalQuestions  --cuda_device 0,1
python multiqa.py train --datasets SQuAD1-1,NewsQA,SearchQA,TriviaQA_wiki,WikiHop,ComplexWebQuestions,DuoRC_Paraphrase,SQuAD2-0,ComQA,DROP,HotpotQA,NaturalQuestions  --cuda_device 0,1

# BoolQ (05/19)
python multiqa.py train --datasets BoolQ  --cuda_device 0,1
python multiqa.py train --datasets SQuAD1-1,NewsQA,SearchQA,TriviaQA_wiki,WikiHop,ComplexWebQuestions,DuoRC_Paraphrase,SQuAD2-0,ComQA,DROP,HotpotQA,NaturalQuestions,BoolQ  --cuda_device 0,1
